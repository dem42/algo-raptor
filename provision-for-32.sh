...
echo "exec sudo /home/vagrant/${TAR}/bin/nodemon /vagrant/server.js > /home/vagrant/algoviz_server.log 2>&1" >> /etc/init/node.conf
...
/home/vagrant/${TAR}/bin/npm install -g nodemon
